...
**Help wanted** This project is looking for contributors to help fix bugs and implement new features. Please check [Issue 192](https://github.com/djangbahevans/go-socket.io/issues/192). All help is much appreciated.
...
```bash
go get github.com/djangbahevans/go-socket.io
```

Import it with:

```go
import "github.com/djangbahevans/go-socket.io"
```
...
Please check more examples into folder in project for details. [Examples](https://github.com/djangbahevans/go-socket.io/tree/master/_examples)
...
- How to use go-socket.io with CORS?
    - Please see examples in [directory](https://github.com/djangbahevans/go-socket.io/tree/master/_examples)
...
This project contains a sub-package called `engineio`. This used to be a separate package under https://github.com/djangbahevans/go-engine.io.
